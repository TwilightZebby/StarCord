...
module.exports = {
    ...
    async execute(interaction)
    {
        ...
        const InviteButton = new ActionRowBuilder().setComponents([
            new ButtonBuilder().setStyle(ButtonStyle.Link).setLabel(localize(interaction.locale, 'SUPPORT_COMMAND_SERVER_BUTTON_LABEL')).setURL("https://discord.gg/4bFgUyWUMY")
        ]);

        await interaction.reply({ ephemeral: true, content: localize(interaction.locale, 'SUPPORT_COMMAND_DESCRIPTION'), components: [InviteButton] });
